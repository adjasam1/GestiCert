...
// 
//    @ResponseBody
//    @RequestMapping("/sendHtmlEmail/{idDemand}")
//    public String sendHtmlEmail(@RequestBody Demand demand, @PathVariable Integer IdDemand) throws MessagingException {
// 
